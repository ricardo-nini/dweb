...
# =============================================================================#
class DSchneider_SEPAM40_Config(DConfig_Slave):
    def __init__(self, rconfig: common.RConfig, slave_num: int):
        super().__init__(rconfig, slave_num)


# =============================================================================#
class DSchneider_SEPAM40_AlarmRele(dreport.DAlarmRele):
    _SIZE = 4
    _flag50_51 = 24
    _flag50N_51N = 25
    _flag27 = 26
    ...
    def __init__(self, data=None, offset=0):
        super().__init__(DSchneider_SEPAM40_AlarmRele._SIZE, data, offset)

    @property
    def flag50_51(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag50_51, self._offset)

    @flag50_51.setter
    def flag50_51(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag50_51, flag, self._offset)

    @property
    def flag50N_51N(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag50N_51N, self._offset)

    @flag50N_51N.setter
    def flag50N_51N(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag50N_51N, flag, self._offset)

    @property
    def flag27(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag27, self._offset)

    @flag27.setter
    def flag27(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag27, flag, self._offset)

    @property
    def flag59(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag59, self._offset)

    @flag59.setter
    def flag59(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag59, flag, self._offset)

    @property
    def flag81(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag81, self._offset)

    @flag81.setter
    def flag81(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag81, flag, self._offset)

    @property
    def flag67(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag67, self._offset)

    @flag67.setter
    def flag67(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag67, flag, self._offset)

    @property
    def flag67N(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag67N, self._offset)

    @flag67N.setter
    def flag67N(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag67N, flag, self._offset)

    @property
    def flag47_1(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag47_1, self._offset)

    @flag47_1.setter
    def flag47_1(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag47_1, flag, self._offset)

    @property
    def flag32P(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag32P, self._offset)

    @flag32P.setter
    def flag32P(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag32P, flag, self._offset)

    @property
    def flag50BF(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag50BF, self._offset)

    @flag50BF.setter
    def flag50BF(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag50BF, flag, self._offset)

    @property
    def flag79_1(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag79_1, self._offset)

    @flag79_1.setter
    def flag79_1(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag79_1, flag, self._offset)

    @property
    def flag79_2(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag79_2, self._offset)

    @flag79_2.setter
    def flag79_2(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag79_2, flag, self._offset)

    @property
    def flag79_3(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag79_3, self._offset)

    @flag79_3.setter
    def flag79_3(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag79_3, flag, self._offset)

    @property
    def flag79_4(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag79_4, self._offset)

    @flag79_4.setter
    def flag79_4(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag79_4, flag, self._offset)

    @property
    def flag79_5(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flag79_5, self._offset)

    @flag79_5.setter
    def flag79_5(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flag79_5, flag, self._offset)

    @property
    def flagDJ(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flagDJ, self._offset)

    @flagDJ.setter
    def flagDJ(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flagDJ, flag, self._offset)

    @property
    def flagBanderolaAtiva(self) -> bool:
        return self._data.is_bit(DSchneider_SEPAM40_AlarmRele._flagBanderolaAtiva, self._offset)

    @flagBanderolaAtiva.setter
    def flagBanderolaAtiva(self, flag):
        self._data.put_bit(DSchneider_SEPAM40_AlarmRele._flagBanderolaAtiva, flag, self._offset)
...
class DSchneider_SEPAM40():
    ...
    def get_alarm(self) -> DSchneider_SEPAM40_AlarmRele:
        ret = DSchneider_SEPAM40_AlarmRele()
...
# =============================================================================#
class DSchneider_SEPAM40_Thread(dslave.DSlave_Thread):
    def __init__(self, slave_num: int, resources: dict):
        ...
        self._device = DSchneider_SEPAM40(self.modbus_slave, self._modbus)
    ...
    def run(self):
        try:
            ...
            previous_alarm = DSchneider_SEPAM40_AlarmRele()
            demanda_lock = False
                ...
                try:
                    ...
                    if self._alarm:
                        ...
                        if actual_alarm is not None:
                            ...
                            previous_alarm = DSchneider_SEPAM40_AlarmRele(actual_alarm.exchange_data())
            ...
            print(type(err))
            self.logger.fatal('Thread DSchneider_SEPAM40_Thread fail:{}'.format(str(err)))
...
# =============================================================================#
class DSchneider_SEPAM40_Process(listen.DListenProcess):
    ...
    def proc_cmd_now(self):
        try:
            ...
            rele = DSchneider_SEPAM40(CONFIG.slaves[header.slave].modbus_slave, self._modbus)
            # Meter
            if header.cmdtype == 0:
                r = rele.get_meter()
